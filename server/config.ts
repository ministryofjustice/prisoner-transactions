...
export default {
  ...
  apis: {
    hmppsAuth: {
      ...
      apiClientId: get('API_CLIENT_ID', 'prisoner-transactions-client', requiredInProduction),
      apiClientSecret: get('API_CLIENT_SECRET', 'clientsecret', requiredInProduction),
      systemClientId: get('SYSTEM_CLIENT_ID', 'prisoner-transactions-admin', requiredInProduction),
